...
We welcome contributions of all kinds! Whether you want to help by fixing bugs, adding features, improving documentation, or refining the user interface, your contributions are appreciated.
...
8. **Submit a pull request**: Go to the repository on GitHub and click "New Pull Request."
